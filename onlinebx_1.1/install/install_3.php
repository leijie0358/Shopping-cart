...
<title><?=isset($site_name)?$site_name:'携程软件'?>安装向导(三)</title>
...
<div class="container">
	<div class="head">
		<img src="images/logo.gif" width="354" height="53" alt="<?=isset($site_name)?$site_name:'携程软件'?>安装向导" />
	</div>  
	<div class="ins_box clearfix">
		<div class="cont clearfix">
			...
			<div class="red_box">本系统目前未采用表名前缀,请安装前确认会否和你现有的表冲突</div> 
			<form action='index.php?act=install_sql' method='post' target="install_iframe" onsubmit="return check_form();">
						...
						<div class="box">
							<table class="form_table">
								...
								<tr>
									<th>数据库名称</th>
									<td>
										<input class="gray" type="text"  name='db_name' /><br />
										<label class="error" id='db_name_label' style='display:none'>
										<img src="images/failed.gif" width="16" height="15" />数据库不能为空
										</label>
									</td>
								</tr>
								<tr>
									<th>账户</th>
									<td>
										<input class="gray" type="text" name='db_user' />
									</td>
								</tr>
								<tr>
									<th>密码</th>
									<td>
										<input class="gray" type="password" name='db_pwd' />
									</td>
								</tr>
								<tr style="display:none">
									<th>数据库表前缀</th>
									<td>
										<input class="gray" type="text" value='jr_' name='db_pre' /><br />
										<label class="error" id='db_pre_label' style='display:none'>
										<img src="images/failed.gif" width="16" height="15" />表前缀不能为空</label>
									</td>
								</tr> 
								<tr>
									<th></th>
									<td>
										<input class="check" type="button" onclick="check_mysql();" />
									</td>
								</tr>
							</table>
							...
							<table class="form_table">
								...
								<tr>
									...
									<td>
										...
										<label class="error" id='admin_pwd_label' style='display:none'><img src="images/failed.gif" width="16" height="15" />密码格式不正确，字符在 1-16个之间</label>
									</td>
								</tr>
								<tr>
									<th>再次确认</th>
							...
							<label for="" style="/*display:none*/"> 
								<input class="radio" type="radio" name='install_type' checked=checked value='simple' />
									不安装测试数据
								<input class="radio" type="radio" name='install_type' value='all' />
									安装测试数据
							</label>
				...
				<p class="operate">
					<input class="return" type="button" onclick="window.location = 'index.php?act=install_2';" />
