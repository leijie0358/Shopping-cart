...
<title><?=isset($site_name)?$site_name:'携程'?>安装向导(一)</title>
<link rel="stylesheet" href="css/install.css" />
</head>
<body>
<div class="container">
	<div class="head"><img src="images/logo.gif" width="354" height="53" alt="<?=isset($site_name)?$site_name:'携程'?>安装向导" /></div>
	<div class="ins_box clearfix">
		<div class="cont clearfix">
			...
			<div class="log_box">
				<h2>
					<img src="images/guide_1.gif" width="203" height="15" />
				</h2>
				...
				<div class="gray_box">
					<div class="box" style="height:314px; overflow-y:auto">
						...
						{
							echo "本地协议不存在，请访问： 
							<a href='http://www.jurensoft.cn/license.html' target='_blank'>
							http://www.jurensoft.cn/license.html</a> 阅读相关协议!"; 
						}
						?>
					</div>
				</div>
	...
	<div class="foot"><a target="_blank" href="http://www.jurensoft.cn">携程软件</a>|<a href="http://www.jurensoft.cn">http://www.jurensoft.cn</a></div>
</div>
