...
?>
	...
	<? foreach(array_keys($result) as $key){?>
		<td align="<?=$key=="类别"?"left":"center"?>"><?=$result[$key]?></td>
		<? if($key!='类别' && $key!='总单数'){?>
...
<table style="margin-left:-3px">
	<tr>
		<td>
			...
			<input type="button" class='btn' id='btn_chart' onclick="showModel('w','查看图表','<?=$root_url?>index.php/fault_stat_byclass/chart/','')"  value=" 查看统计图表 "></input>
		</td>
	</tr>
</table>
