		...
		<div id="pagebody">
			<div id="sidebar">
				<div class="drawers-wrapper"> 
					...
					<ul class="drawers">
						<?//echo "<script>alert('".$root_url."');</script>";
						if($this->session->userdata("user")==null)
						{
							redirect($root_url."index.php/user/login");
							//redirect("?logout=");
						} 
						...
						foreach($top_resources as $top_resource)
						{
							...
							{
								$iscan = $this->autho->isauth($user->role_id,$top_resource->id,"show");
							}
							if($iscan)
							{
					    ?>
						<li class="drawer">
							...
							<ul>
								...
								{
									if($user->role_type==3 || $this->autho->isauth($user->role_id,$resource->id,"index"))
									{
								?>
			...
			<div id="content">
				...
				<ul id="breadcrumb">
					<li id="breadcrumb-home">
							<img src="<?=$root_url?>application/views/images/home.gif" alt="Home" class="home" />
					</li>
					<li width="600px" style="padding-top:2px;font-size:14px;color:#333333">&nbsp;&nbsp;<?=(isset($navigate_string)?$navigate_string:"提示")?></li> 
				</ul>
