...
logos+= '<input type="hidden" id="e7" name="e7" class="bigdrop" style="width:80%;top:-35px;margin-top:0px;height=50px" required="true" onchange="showdetail()"/>';
logos+= '<img src="search.png" style=“position:absolute;top:100px"  onClick="searchPerson()" />';
...
logos+= '<input type="hidden" id="e5" name="e5" class="bigdrop" style="width:80%;top:-35px;margin-top:0px;height=50px" required="true" onchange="showdeptdetail()"/>';
logos+= '<img src="search.png" onClick="searchRoom()" />';
...
//logos+='<select name="meetroom" id="meetroom" onchange="showroomByList()"></select>';
logos+= '<input type="hidden" id="e6" name="e6" class="bigdrop" style="width:80%;top:-35px;margin-top:0px;height=50px" required="true" onchange="showroomdetail()"/>';
logos+= '<img src="search.png" onClick="searchRoom()" />';
//logos+= '<input class="btn btn-primary" type="button" value="SearchRoom" onClick="searchRoom()"/>';
